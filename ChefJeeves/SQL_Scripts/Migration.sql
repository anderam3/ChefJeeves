...
BEGIN
  SELECT b.Ingredient_Name as NAME, b.Ingredient_ID as ID 
  FROM AccountDietRestriction a, Ingredient b
  WHERE a.Diet_Restriction_ID = b.Ingredient_ID and a.username = User and b.INGREDIENT_NAME LIKE CONCAT(Ingredient,'%')
  ORDER BY b.Ingredient_Name;
END$$
...
BEGIN
  ...
  FROM AccountDietRestriction a, Ingredient b
  WHERE a.Username = user
  and a.Diet_Restriction_ID = b.Ingredient_ID
  and b.INGREDIENT_NAME LIKE CONCAT(Ingredient,'%'))
  ORDER BY b.Ingredient_Name;
END$$
